...
// Generates the animation array for the selected sorting algorithm
// and triggers the sorting animation.
...
// Sorting algorithm metadata, including time complexities and descriptions
export const sortingAlgorithmsData = {
  bubble: {
    ...
    worstCase: "O(n²)",    // Worst-case time complexity
    averageCase: "O(n²)",  // Average-case time complexity
    bestCase: "O(n)",      // Best-case time complexity (already sorted input)
  },
  insertion: {
